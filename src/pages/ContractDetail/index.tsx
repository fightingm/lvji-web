...
const TableList: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ws = new WebSocket(
      `wss://xj102db493504.vicp.fun/api/llm-service/review-contract/34?Authorization=${token.slice(
        7,
      )}`,
    );
    ws.onopen = function () {
    ...
    ws.onmessage = function (evt) {
      ...
      if (data.chunkResults) {
        setItems((v) => v.concat(data.chunkResults));
      }
    };
    ...
    <PageContainer>
      <div className="flex">
        <div className="flex-1 border bg-white">
          ...
          ></div> */}
          <iframe
            src="https://view.officeapps.live.com/op/view.aspx?src=https://yema-1252530263.cos.ap-chengdu.myqcloud.com/test/67d53255533aeb080253ef2a.doc"
            width="100%"
            height="100%"
            frameBorder="1"
          ></iframe>
        ...
        <div className="flex shrink-0 w-[622px] px-2 h-screen overflow-hidden">
          <div className="mr-4 flex-1 rounded-xl border bg-[#f7f8fa] shadow p-6 pt-0 h-full [&_.ant-tabs]:h-full [&_>.ant-tabs-content-holder]:!flex-1 [&_.ant-tabs-content-holder]:!overflow-auto">
            {loading ? (
              <Loading />
            ) : mode === 0 ? (
